...
const Card = React.forwardRef(({ className, ...props }, ref) => (<div ref={ref} className={cn("glass-panel glass-interactive rounded-[12px] text-card-foreground", className)} {...props}/>));
